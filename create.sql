...
CREATE TABLE Race (id UUID, horse BIGINT REFERENCES Horse, jockey BIGINT REFERENCES Jockey, talent DOUBLE, speed DOUBLE, luckyNumber DOUBLE, rank INTEGER, PRIMARY KEY(id, horse, jockey));
